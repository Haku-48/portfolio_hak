  ...
  return (
    <main className="page" id="home">
      ...
      <p className="description">
        En parallèle de ma troisième année de licence informatique, je développe
        continuellement mes compétences sur divers langages et outils pour
        transformer des idées en projets concrets.
      </p>
      <div className="ctas">
        N'hésitez pas à me contacter où à jeter un coup d'oeil à mes différents
        projets.
